...
HD_PWD='/home/brett/Programming/School/CPE_133/final/Binary_to_BCD/Binary_to_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_Wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Counter_Wrapper.tcl
