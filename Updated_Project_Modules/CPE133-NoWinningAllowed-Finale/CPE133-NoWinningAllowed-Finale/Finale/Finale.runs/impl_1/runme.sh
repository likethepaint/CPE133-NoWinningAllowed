...
HD_PWD='C:/Users/ckenner/Desktop/CPE133-NoWinningAllowed-Finale/CPE133-NoWinningAllowed-Finale/Finale/Finale.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log State_Machine_Wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source State_Machine_Wrapper.tcl -notrace
