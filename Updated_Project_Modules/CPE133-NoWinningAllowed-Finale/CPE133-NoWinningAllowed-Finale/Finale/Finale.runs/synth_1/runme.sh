...
HD_PWD='C:/Users/ckenner/Desktop/CPE133-NoWinningAllowed-Finale/CPE133-NoWinningAllowed-Finale/Finale/Finale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log State_Machine_Wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source State_Machine_Wrapper.tcl
