...
HD_PWD='/home/brett/Programming/School/CPE_133/CPE133-NoWinningAllowed/Seven_Seg_Display_Easy/Seven_Seg_Display_Easy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_Source.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Display_Source.tcl -notrace
