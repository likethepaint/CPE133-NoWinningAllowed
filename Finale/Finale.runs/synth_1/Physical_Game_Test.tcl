...
read_vhdl -library xil_defaultlib {
  ...
  /home/brett/Programming/School/CPE_133/CPE133-NoWinningAllowed/VHDL_FILES/Physical_Game_Test.vhd
}
...
synth_design -top Physical_Game_Test -part xc7a35tcpg236-1


write_checkpoint -force -noxdef Physical_Game_Test.dcp

catch { report_utilization -file Physical_Game_Test_utilization_synth.rpt -pb Physical_Game_Test_utilization_synth.pb }
