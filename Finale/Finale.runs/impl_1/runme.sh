...
HD_PWD='/home/brett/Programming/School/CPE_133/CPE133-NoWinningAllowed/Finale/Finale.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Physical_Game_Test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Physical_Game_Test.tcl -notrace
